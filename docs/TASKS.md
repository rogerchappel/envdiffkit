...
Ship a genuinely usable local-first TypeScript CLI for `envdiffkit` matching `docs/PRD.md`.
...
7. Publish
   - Create public GitHub repo `rogerchappel/envdiffkit` if absent.
   - Push directly to `main` as Roger/admin.
   - Protect `main` best-effort using `/Users/roger/.openclaw/workspace/scripts/protect-github-main.sh rogerchappel envdiffkit main`.
